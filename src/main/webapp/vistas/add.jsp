        ...
        <div>
            <div class="box-formulario"> 
                ...
                <form action="Controlador" class="form-group"> 
                    ...
                    <input type="text"  name="txt_nombre_mascota" class="form-control"><br> 
                     <label class="label">Direccion:</label>
                    <input type="text" name="txt_direccion_mascota" class="form-control"><br>
                      <label class="label">Raza:</label>
                    <input  type="text" name="txt_Raza_mascota" class="form-control"><br>
                      <label class="label">Edad:</label>
                    <input type="text" name="txt_edad_mascota" class="form-control"><br>
                    <a><button id="btn-regresar" class="btn btn-info" name="accion" value="Agregar">Agregar</button></a>
                    <a href="Controlador?accion2=listar" name="accion" value="Listar"><button id="btn-regresar" class="btn btn-info" name="accion" value="listar">Regresar</button></a>
                </form>
            </div>
        </div>
                          <!--todo || Pie de página || --> 
